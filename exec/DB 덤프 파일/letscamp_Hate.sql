...
CREATE TABLE `Hate` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKlkm6vrc3wa9y9uqnhnsleffj` (`camping_id`),
  KEY `FKegm029usa2qjkt25abnpw9312` (`user_id`),
  CONSTRAINT `FKegm029usa2qjkt25abnpw9312` FOREIGN KEY (`user_id`) REFERENCES `User` (`id`),
  CONSTRAINT `FKlkm6vrc3wa9y9uqnhnsleffj` FOREIGN KEY (`camping_id`) REFERENCES `Camping` (`id`)
